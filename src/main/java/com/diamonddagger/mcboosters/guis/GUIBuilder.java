...
public class GUIBuilder {
  ...
  private GUIInventoryFunction buildGUIFunction = (GUIBuilder builder) -> {
    ...
    for(String itemName : config.getConfigurationSection(path + "Items").getKeys(false)){
      ...
      if(type.equals(Material.PLAYER_HEAD)){
        ...
        sm.setOwningPlayer(player.getPlayer());
      }
   ...
   * @param player
   */
  public GUIBuilder(String fileName, String guiPath, BoosterPlayer player){
    this.player = player;
    File f = new File(McBoosters.getInstance().getDataFolder(), File.separator + "guis" + File.separator + fileName);
   ...
   * @param player
   */
  public GUIBuilder(String guiPath, FileConfiguration config, BoosterPlayer player){
    this.player = player;
    this.rawPath = guiPath;
    this.config = config;
    this.path = "Gui." + guiPath + ".";
   ...
   * @param player
   */
  public GUIBuilder(String guiPath, FileConfiguration config, BoosterPlayer player, boolean generateInvs){
    this.player = player;
    this.rawPath = guiPath;
    this.config = config;
    this.path = "Gui." + guiPath + ".";
  ...
  public GUIBuilder(BoosterPlayer player){
    this.player = player;
  }
